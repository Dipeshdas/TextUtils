      ...
      >
        ...
        <div className="mb-3">
          <textarea
            ...
            value={text}
            style={{
              backgroundColor: props.mode === "dark" ? "#5d607e" : "white",
        ...
        <button
          ...
          type="button"
          style={{ backgroundColor: props.mode === "primary" ? "#f07e22" : "" }}
        ...
        <button
          ...
          type="button"
          style={{
            backgroundColor: props.mode === "secondary" ? "#f07e22" : "",
          }}
          className="btn btn-secondary mx-3 my-1"
        ...
        <button
          disabled={text.length === 0}
          type="button"
          style={{ backgroundColor: props.mode === "success" ? "#f07e22" : "" }}
        ...
        <button
          disabled={text.length === 0}
          type="button"
          style={{ backgroundColor: props.mode === "danger" ? "#f07e22" : "" }}
        ...
        <button
          disabled={text.length === 0}
          type="button"
          style={{ backgroundColor: props.mode === "warning" ? "#f07e22" : "" }}
        ...
        <button
          disabled={text.length === 0}
          type="button"
          style={{ backgroundColor: props.mode === "info" ? "#f07e22" : "" }}
